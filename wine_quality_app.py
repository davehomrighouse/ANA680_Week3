...
Original file is located at
    https://colab.research.google.com/drive/1dfFwHKWTOSZl-JP0opzVxvS_PAEsn97n
"""
...
def make_prediction(form_data):
    ...
    X_scaled = scaler.transform(X_df)  # Scale numeric features

    # Get class probabilities
    probs = rfc.predict_proba(X_scaled)[0]   # shape (n_classes,)
    classes = rfc.classes_                   # e.g. [3, 4, 5, 6, 7, 8, 9]
